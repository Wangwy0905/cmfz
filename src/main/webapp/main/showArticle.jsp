...
<%@page contentType="text/html; charset=utf-8" pageEncoding="utf-8"%>
    ...
    <script type="text/javascript">
        function test(){
            ...
            var kw=$("#kw2").val();
            // alert(kw);
            $.post("${pageContext.request.contextPath}/articleLucene/showArticleLucene",
                "param="+kw,
                function(result){
                    $("#tbody").empty();
                    for(var i=0;i<result.length;i++){

                        var ll="${pageContext.request.contextPath}/shouye/"+result[i].insertImg;

                        var td1=$("<tr><td>"+result[i].title+"</td></tr>");
                        var td2=$("<tr><td>"+result[i].content+"</td></tr>");
                        var td3=$("<tr><td></td></tr>").html("<img src='"+ll+"'/>");
                        var td4=$("<tr><td>"+result[i].pubDate+"</td></tr>");

                        var td5=$("<tr><td></td></tr>").text("--------------------");

                        $("#tbody").append(td1).append(td2).append(td3).append(td4).append(td5);
    ...
    <div id="s_fm" class="s_form">
        <div class="s_form_wrapper" id="s_form_wrapper">
            ...
            <form id="form" action="" class="fm">
                <input type="text" class="s_ipt" name="keyWords" id="kw2" maxlength="100" autocomplete="off">
